//victory and gameover functions
	...
	//gameover
	function gameover() {
		var nero = "<p id='nero' class='reload'> </p>";
	...
	//victory
	function victory() {
		var bianco = "<p id='bianco' class='reload'>Cheers! You kept the balance</p>";
		//jQuery("#comments").fadeIn();

		var footer = "<p class='myfoot my1'>A game by <br><span id='name'>Margherita Magatti</span></p> <p class='myfoot my2'>Corso di Laurea in<br>Design della Comunicazione<br>Politecnico di Milano</p>"
